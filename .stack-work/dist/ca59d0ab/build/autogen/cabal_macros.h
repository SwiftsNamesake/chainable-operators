...
/* package chained-operators-0.1.0.0 */
#define VERSION_chained_operators "0.1.0.0"
#define MIN_VERSION_chained_operators(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "chained-operators-0.1.0.0-GkBvuZfGoz5312Kp8mtkpo"

#define CURRENT_PACKAGE_KEY "chained-operators-0.1.0.0-GkBvuZfGoz5312Kp8mtkpo"
